...
public class LocalizationService : INotifyPropertyChanged
{
    ...
    private static readonly Dictionary<string, string> BuiltInDefaults = new(StringComparer.OrdinalIgnoreCase)
    {
        ...
        ["Card_ExpiringSoonPill"] = "Expiring Soon",
        ["Card_ExpiredPill"] = "Expired",
        ["Card_DaysRemaining"] = "{0}d remaining",
        ["Card_NoUpn"] = "Not Specified in SAN",
        ...
        ["EnrollDialog_UserPrefix"] = "User",
        ["Enroll_StatusReady"] = "Ready to enroll.",
        ["Enroll_ErrorEnterPin"] = "Please enter your YubiKey PIN.",
        ["Enroll_ErrorCommonNameRequired"] = "Common Name is required.",
        ["Enroll_StatusGeneratingKey"] = "Connecting to YubiKey PIV and generating asymmetric key pair on token...",
        ["Enroll_StatusSubmittingCsr"] = "Submitting CSR to Windows CA with template '{0}'...",
        ["Enroll_StatusInstallingCert"] = "Writing issued X.509 certificate to YubiKey Slot 9a...",
        ["Enroll_ErrorImportFailed"] = "Failed to import certificate into YubiKey.",
        ["Enroll_StatusSuccess"] = "PIV certificate successfully enrolled and installed!",
